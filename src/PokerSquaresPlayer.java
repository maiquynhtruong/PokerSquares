...
public interface PokerSquaresPlayer {
	 ...
	 * Thus, this method contains all information necessary to
	 * maintain current game state for the player.
	 * @param card - card just drawn.
	 * @param millisRemaining - remaining milliseconds for play
	 * in the rest of the player's game.
